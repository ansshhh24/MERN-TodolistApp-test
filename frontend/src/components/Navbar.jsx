...
const Navbar = () => {
  ...
  return (
    <>
      <header className='flex justify-between sticky top-0 p-4 bg-accent shadow-sm items-center'>
        ...
        <ul className='hidden md:flex gap-4 uppercase font-medium'>
          {authState.isLoggedIn ? (
            ...
            <li className='py-2 px-3 cursor-pointer text-black hover:bg-primary transition rounded-md'><Link to="/login">Login</Link></li>
          )}
        </ul>

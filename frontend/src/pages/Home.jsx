...
const Home = () => {
  ...
  return (
    <>
      <MainLayout>
        {!isLoggedIn ? (
          <div className='bg-primary rounded-xl grid place-items-center text-white h-[40vh] py-8 text-center'>
            <h1 className='text-3xl'> Welcome to Task Manager App</h1>
             <div className=' py-8 mt-10  rounded-2xl bg-primary-dark w-80 hover:bg-slate-900'>
